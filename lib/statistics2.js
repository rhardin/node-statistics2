...
(function () {
    var SQ2PI = Math.sqrt(2 * Math.PI),
        ...
        N = 8,
        B0  = 1.0, // jshint ignore:line
        B1  = -1.0 / 2.0, // jshint ignore:line
        B2  = 1.0 / 6.0,
        B4  = -1.0 / 30.0,
        B6  =  1.0 / 42.0,
        B8  = -1.0 / 30.0,
        ...
        combi = function (n, x) {
            ...
            if (z * 2 > n) { x = n - x; } // jshint ignore:line
    ...
    function q_chi2(df, chi2) {
        ...
        if ((df & 1) !== 0) {
            ...
            if (df === 1) { return 2 * normal__x(chi); } // jshint ignore:line
            ...
            return 2 * (normal__x(chi) + s); // jshint ignore:line
        }
    ...
    function chi2dens(n, x) { // jshint ignore:line
        var n2;
    ...
    function pt(q, n) {
        var f1 = 0, f2 = 0, f3 = 0, f4 = 0, f5 = 0, u = 0, w0 = 0, w1 = 0, w2 = 0, w3 = 0, w4 = 0, w = 0, u2, f; //leak?
    ...
    // [x, \infty)
    function pf(q, n1, n2) {
        var eps, fw, s, qe, w1, w2, w3, w4, u, u2, a, b, c, d, qn;
        ...
        if (d < 0.0) {
            ...
            if (a.abs > eps) {
                ...
                if (abs(b) > eps) { return -c / b; } // jshint ignore:line
                fw = pfsub(a, b, 0.0);
            }
        }
